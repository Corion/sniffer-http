...
# These definitions are from config.sh (via /opt/perl/lib/5.8.8/i686-linux/Config.pm)
...
SITEARCHEXP = /opt/perl/lib/site_perl/5.8.8/i686-linux
SO = so
EXE_EXT = 
FULL_AR = /usr/bin/ar
VENDORARCHEXP = 
...
INSTALLARCHLIB = /opt/perl/lib/5.8.8/i686-linux
DESTINSTALLARCHLIB = $(DESTDIR)$(INSTALLARCHLIB)
INSTALLSITEARCH = /opt/perl/lib/site_perl/5.8.8/i686-linux
...
PERL_LIB = /opt/perl/lib/5.8.8
PERL_ARCHLIB = /opt/perl/lib/5.8.8/i686-linux
LIBPERL_A = libperl.a
FIRST_MAKEFILE = Makefile
MAKEFILE_OLD = Makefile.old
MAKE_APERL_FILE = Makefile.aperl
PERLMAINCC = $(CC)
PERL_INC = /opt/perl/lib/5.8.8/i686-linux/CORE
...
MAKEMAKER   = /opt/perl/lib/5.8.8/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.30
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) '    Exporter::Lite:                0' >> META_new.yml
...
ppd:
	$(NOECHO) $(ECHO) '<SOFTPKG NAME="$(DISTNAME)" VERSION="0,16,0,0">' > $(DISTNAME).ppd
