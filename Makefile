...
#     NAME => q[Sniffer::HTTP]
#     PREREQ_PM => { Net::Pcap=>q[0.09], Exporter::Lite=>q[0], NetPacket::TCP=>q[0], Class::Data::Inheritable=>q[0], Class::Accessor=>q[0], LWP::Simple=>q[0], HTTP::Request=>q[0] }
...
# These definitions are from config.sh (via /opt/perl/lib/5.8.7/i686-linux/Config.pm)
...
OSVERS = 2.4.27-2-386
RANLIB = :
SITELIBEXP = /opt/perl/lib/site_perl/5.8.7
SITEARCHEXP = /opt/perl/lib/site_perl/5.8.7/i686-linux
SO = so
EXE_EXT = 
FULL_AR = /usr/bin/ar
VENDORARCHEXP = 
...
INSTALLARCHLIB = $(PERLPREFIX)/lib/5.8.7/i686-linux
DESTINSTALLARCHLIB = $(DESTDIR)$(INSTALLARCHLIB)
INSTALLSITEARCH = $(SITEPREFIX)/lib/site_perl/5.8.7/i686-linux
...
PERL_LIB = /opt/perl/lib/5.8.7
PERL_ARCHLIB = /opt/perl/lib/5.8.7/i686-linux
LIBPERL_A = libperl.a
FIRST_MAKEFILE = Makefile
MAKEFILE_OLD = $(FIRST_MAKEFILE).old
MAKE_APERL_FILE = $(FIRST_MAKEFILE).aperl
PERLMAINCC = $(CC)
PERL_INC = /opt/perl/lib/5.8.7/i686-linux/CORE
PERL = /opt/perl/bin/perl5.8.7
FULLPERL = /opt/perl/bin/perl5.8.7
ABSPERL = $(PERL)
PERLRUN = $(PERL)
...
MAKEMAKER   = /opt/perl/lib/5.8.7/ExtUtils/MakeMaker.pm
MM_VERSION  = 6.17
MM_REVISION = 1.133
...
$(INST_AUTODIR)/.exists :: /opt/perl/lib/5.8.7/i686-linux/CORE/perl.h
	$(NOECHO) $(MKPATH) $(INST_AUTODIR)
	$(NOECHO) $(EQUALIZE_TIMESTAMP) /opt/perl/lib/5.8.7/i686-linux/CORE/perl.h $(INST_AUTODIR)/.exists

	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_AUTODIR)

$(INST_LIBDIR)/.exists :: /opt/perl/lib/5.8.7/i686-linux/CORE/perl.h
	$(NOECHO) $(MKPATH) $(INST_LIBDIR)
	$(NOECHO) $(EQUALIZE_TIMESTAMP) /opt/perl/lib/5.8.7/i686-linux/CORE/perl.h $(INST_LIBDIR)/.exists

	-$(NOECHO) $(CHMOD) $(PERM_RWX) $(INST_LIBDIR)

$(INST_ARCHAUTODIR)/.exists :: /opt/perl/lib/5.8.7/i686-linux/CORE/perl.h
	$(NOECHO) $(MKPATH) $(INST_ARCHAUTODIR)
	$(NOECHO) $(EQUALIZE_TIMESTAMP) /opt/perl/lib/5.8.7/i686-linux/CORE/perl.h $(INST_ARCHAUTODIR)/.exists
...
$(INST_MAN3DIR)/.exists :: /opt/perl/lib/5.8.7/i686-linux/CORE/perl.h
	$(NOECHO) $(MKPATH) $(INST_MAN3DIR)
	$(NOECHO) $(EQUALIZE_TIMESTAMP) /opt/perl/lib/5.8.7/i686-linux/CORE/perl.h $(INST_MAN3DIR)/.exists
...
realclean purge ::  clean realclean_subdirs
	...
	$(RM_RF) $(DISTVNAME)
	$(RM_F)  blib/lib/Net/Pcap/FindDevice.pm blib/lib/Sniffer/Connection.pm blib/lib/Sniffer/Connection/HTTP.pm blib/lib/Sniffer/HTTP.pm $(MAKEFILE_OLD) $(FIRST_MAKEFILE)
...
metafile :
	...
	$(NOECHO) $(ECHO) '    Exporter::Lite:                0' >> META.yml
	$(NOECHO) $(ECHO) '    HTTP::Request:                 0' >> META.yml
	$(NOECHO) $(ECHO) '    LWP::Simple:                   0' >> META.yml
	$(NOECHO) $(ECHO) '    Net::Pcap:                     0.09' >> META.yml
...
ppd:
	...
	$(NOECHO) $(ECHO) '        <DEPENDENCY NAME="Exporter-Lite" VERSION="0,0,0,0" />' >> $(DISTNAME).ppd
